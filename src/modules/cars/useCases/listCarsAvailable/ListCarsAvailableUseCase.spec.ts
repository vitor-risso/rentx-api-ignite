...
describe("Lir cars", () => {
  ...
  beforeEach(() => {
    ...
    listCarsAvailableUseCase = new ListCarsAvailableUseCase(repository)
  })
  ...
  it('should be able to list all available cars by name', async () => {
    ...
    const cars = await listCarsAvailableUseCase.execute({ name: car.name })
  ...
  it('should be ableto list all available cars brand', async () => {
    ...
    const cars = await listCarsAvailableUseCase.execute({ brand: car.brand })
  ...
  it('should be ableto list all available cars by category_id', async () => {
    ...
    const cars = await listCarsAvailableUseCase.execute({ category_id: car.category_id })
